...
$size_libraries = $d->rawQuery("select id,ten$lang from #_product_size where hienthi=1 ");
$global_size = array();

if(!empty($size_libraries)){
	foreach($size_libraries as $size){
		$global_size[$size['id']] = $size["ten$lang"];
	}
}
?>
<!DOCTYPE html>
