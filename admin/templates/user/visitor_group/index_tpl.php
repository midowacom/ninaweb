<?php
    ...
    $linkAdd = "index.php?com=user&act=add_group&p=".$curPage;
	$linkEdit = "index.php?com=user&act=edit_group&p=".$curPage;
	$linkDelete = "index.php?com=user&act=delete_group&p=".$curPage;
?>
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Quản lý Nhóm tài khoản khách</li>
            </ol>
        </div>
    </div>
</section>
                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a class="text-dark" href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['title']?>"><?=$items[$i]['title']?></a>
                                </td>
