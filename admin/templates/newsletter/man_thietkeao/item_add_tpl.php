        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group-category row">
                    <label for="img">Design khách hàng</label>
                ...
                <div class="form-group-category row">
                    ...
                    <?php if(isset($config['newsletter'][$type]['soluong']) && $config['newsletter'][$type]['soluong'] == true) { ?>
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="data[soluong]" id="soluong" placeholder="Số lượng" value="<?=@$item['soluong']?>" disabled>
                        </div>
                    <?php } ?>
                    ...
                    <?php if(isset($config['newsletter'][$type]['gia']) && $config['newsletter'][$type]['gia'] == true) { ?>
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control format-price gia_ban" name="data[gia]" id="gia" placeholder="Số lượng" value="<?=@$item['gia']?>" disabled>
                        </div>
                    <?php } ?>    
                    ...
                    <?php 
                    $item_sizes =  json_decode(@$item['options'],1);
                    foreach ($item_sizes as $k => $v): ?>
                            <div class="form-group col-md-2 col-sm-3 col-6">
                                <label><?=$global_size[$k]?></label>
                                <input type="text" class="form-control" value="<?=$v?>" name="soluong[<?=$k?>]">
                            </div>
                        <?php endforeach ?>
