	                        ...
	                        <?php foreach($chitietdonhang as $k => $v) { ?>
	                            <tr>
	                                ...
	                                <td class="align-middle">
										...
										<?php if($v['mau']!='' || $v['size']!='' || $v['quanprice']!='') { ?>
											<p class="mb-0">
												<?php if($v['mau']!='') { ?>
	                                ...
	                                <td class="align-middle text-center">
	                                	<div class="price-cart-detail">
											<?php if($v['giacu']) { ?>
												<span class="price-new-cart-detail"><?=$func->format_money($v['giacu'])?></span>
	                                ...
	                                <td class="align-middle text-right">
	                                	<div class="price-cart-detail">
											<?php if($v['giacu']) { ?>
												<span class="price-new-cart-detail"><?=$func->format_money($v['giacu']*$v['soluong'])?></span>
