<?php
    ...
    $linkSave = "index.php?com=design&act=save_size&type=".$type."&p=".$curPage;
?>
<!-- Content Header -->
    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title"><?=($act=="edit_size")?"Cập nhật":"Thêm mới";?> kích thước <?=$config['design'][$type]['title_main']?></h3>
            </div>
            <div class="card-body">
