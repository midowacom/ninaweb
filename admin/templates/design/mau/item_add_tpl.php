<?php
    ...
    $linkSave = "index.php?com=design&act=save_mau&type=".$type."&p=".$curPage;
?>
<!-- Content Header -->
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Chi tiết màu sắc <?=$config['design'][$type]['title_main']?></li>
            </ol>
        </div>
    </div>
</section>
    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title"><?=($act=="edit_mau")?"Cập nhật":"Thêm mới";?> màu sắc <?=$config['design'][$type]['title_main']?></h3>
            </div>
            <div class="card-body">
				<?php if(isset($config['design'][$type]['mau_images']) && $config['design'][$type]['mau_images'] == true) { ?>
                    <div class="form-group">
                        ...
                        <strong class="d-block mt-2 mb-2 text-sm"><?php echo "Width: ".$config['design'][$type]['width_mau']." px - Height: ".$config['design'][$type]['height_mau']." px (".$config['design'][$type]['img_type_mau'].")" ?></strong>
				...
				<?php } ?>
                <div class="row">
    				<?php if(isset($config['design'][$type]['mau_mau']) && $config['design'][$type]['mau_mau'] == true) { ?>
    				...
    				<?php } ?>
    				<?php if(
                        (isset($config['design'][$type]['mau_loai']) && $config['design'][$type]['mau_loai'] == true) && 
                        (isset($config['design'][$type]['mau_images']) && $config['design'][$type]['mau_images'] == true)
                    ) { ?>
    					<div class="form-group col-md-3 col-sm-4">
