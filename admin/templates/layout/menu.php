            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                if(isset($config['group'])) { 
                    foreach($config['group'] as $key => $value) {
                        ...
                        if($l) { ?>
                            <li class="nav-item has-treeview menu-group">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    if(isset($value['product'])) { foreach($value['product'] as $k) { ?>
                                        <?php
                                        ...
                                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                                            ...
                                            <ul class="nav nav-treeview">
                                                ...
                                                <?php if(isset($v['brand']) && $v['brand'] == true) {
                                                    ...
                                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_brand&type=<?=$k?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục <?=$v["title_main_brand"]?></p></a></li>
                                                <?php } ?>

                                                <?php 


                                                if(isset($v['area']) && $v['area'] == true) {
                                                    $none = "";
                                                    $active = "";
                                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_area', $k, null, 'phrase-1')) $none = "d-none";
                                                    if($com=='product' && ($act=='man_area' || $act=='add_area' || $act=='edit_area') && $k==$_GET['type']) $active = "active"; ?>
                                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_area&type=<?=$k?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục hãng</p></a></li>
                                                <?php } ?>
                        ...
                        <!-- Coupon -->
                        <?php if(isset($config['coupon']['active']) && $config['coupon']['active'] == true) { ?>
                            <?php
                            $none = "";
                            $active = "";
                            if(isset($kiemtra) && $kiemtra == true) if($func->check_access('coupon', 'man', '', null, 'phrase-1')) $none = "d-none";
                            if($com=='coupon') $active = 'active';
                            ?>
                            <li class="nav-item <?=$active?> <?=$none?>">
                                <a class="nav-link <?=$active?>" href="index.php?com=coupon&act=man" title="Quản lý mã giảm giá">
                            ...
                            <?php foreach($config['product'] as $k => $v) { if(!isset($disabled['product'][$k])) { ?>
                                ...
                                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <?php if(isset($v['area']) && $v['area'] == true) {
                                            $none = "";
                                            $active = "";
                                            if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_area', $k, null, 'phrase-1')) $none = "d-none";
                                            if($com=='product' && ($act=='man_area' || $act=='add_area' || $act=='edit_area') && $k==$_GET['type']) $active = "active"; ?>
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_area&type=<?=$k?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục khu vực</p></a></li>
                                        <?php } ?>
                                        ...
                                        <?php if(isset($v['price']) && $v['price'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_price&type=<?=$k?>" title="Danh mục khoảng giá"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục khoảng giá</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['material']) && $v['material'] == true) {
                                            $none = "";
                                            $active = "";
                                            if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_material', $k, null, 'phrase-1')) $none = "d-none";
                                            if($com=='product' && ($act=='man_material' || $act=='add_material' || $act=='edit_material') && $k==$_GET['type']) $active = "active"; ?>
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_material&type=<?=$k?>" title="Danh mục chất liệu"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục chất liệu</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['mau']) && $v['mau'] == true) {
                                            $none = "";
                                            $active = "";
                        ...
                        <?php include __DIR__."/menu_design.php"; ?>
                        <!-- Bài viết (Có cấp) -->
