<?php 
	$linkMan = "index.php?com=product&act=quanprice&kind=man&idc=".$idc."&type=".$type."&p=".$curPage;
	$linkAdd = "index.php?com=product&act=quanprice&kind=add&idc=".$idc."&type=".$type."&p=".$curPage;
    $linkEdit = "index.php?com=product&act=quanprice&kind=edit&idc=".$idc."&type=".$type."&p=".$curPage;
    $linkDelete = "index.php?com=product&act=quanprice&kind=delete&idc=".$idc."&type=".$type."&p=".$curPage;
?>
<!-- Content Header -->
