<?php
$linkMan = "index.php?com=product&act=quanprice&kind=man&type=".$type."&idc=".$idc."&p=".$curPage;
$linkSave = "index.php?com=product&act=quanprice&kind=save&type=".$type."&idc=".$idc."&p=".$curPage;
?>
<!-- Content Header -->
    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    ...
                    <div class="card-body card-article">
                        ...
                        <?php
                        if(isset($config['product'][$type]['quanprice_fromto']) && $config['product'][$type]['quanprice_fromto'] == true)
                            { ?>   
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control format-price gia" name="data[gia]" id="gia" placeholder="Giá" value="<?=@$item['gia']?>">
                                        <div class="input-group-append">
            ...
            <div class="card-footer text-sm">
                ...
                <input type="hidden" name="data[id_product]" value="<?=@$idc?>">
            </div>
        </form>
    </section>