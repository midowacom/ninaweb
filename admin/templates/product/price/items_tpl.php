<?php 
	...
	$linkAdd = "index.php?com=product&act=add_price&type=".$type."&p=".$curPage;
    $linkEdit = "index.php?com=product&act=edit_price&type=".$type."&p=".$curPage;
    $linkDelete = "index.php?com=product&act=delete_price&type=".$type."&p=".$curPage;
?>
<!-- Content Header -->
