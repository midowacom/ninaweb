...
$linkQuanprice = "index.php?com=product&act=quanprice&kind=man&type=".$type."&p=".$curPage;
              ...
              <td class="align-middle">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown-gallery">
                       ...
                       <?php } ?>
                       <?php if(isset($config['product'][$type]['statistics']) && $config['product'][$type]['statistics']==true) { ?>
                      ...
                      <?php } ?>
                      <?php if(isset($config['product'][$type]['quanprice']) && $config['product'][$type]['quanprice']==true) { ?>
