...
<div class="container">
    <div class="row">
        ...
        <div class="col-9">
            <div class="wrap-user">
                <div class="title-user bg-info">
                    <span class="text-white"><?=thongtinnhom?></span>
                </div>
                <div class="w-100 py-3 px-4">
                    <p><strong class="mr-2"><?=bandangthuocnhom?>:</strong><span><?=$info_member_group["title"]?></span></p>
                    <p><strong class="mr-2"><?=muchietkhau?>:</strong><span><?=$info_member_group["chietkhau"]?>%</span></p>
                </div>
            </div>
            <div class="wrap-user">
