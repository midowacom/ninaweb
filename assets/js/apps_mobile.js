...
if ($("#sliderindex").exists()) {
	var index_slider_options = {
		loop: false,
		pagination: {
...
$(".tieuchi-header-item").on("click",function(){
	var t  = $(this).data("src");
...
$(document).ready(function(){
	...
	NN_FRAMEWORK.Cart();
	var index_spnoibat_slider = new Swiper("#sliderindex .swiper-container", index_slider_options);
	...
	var index_slider_news_video = new Swiper("#index-news-dichvu .swiper-container", {
		loop: false,
		pagination: {
			el: '#index-news-dichvu .swiper-pagination',
			clickable: true,
		},
		navigation: {
			nextEl: '#index-news-dichvu .swiper-button-next',
			prevEl: '#index-news-dichvu .swiper-button-prev',
		},
		// autoplay: {
		// 	delay: 2500,
		// 	disableOnInteraction: false,
	...
	var index_slider_psanpham= new Swiper("#index-slider-product_noibat_sanpham .swiper-container", {
		loop: false,
		slidesPerView: 1,
		spaceBetween: 0,
		pagination: {
			el: '#index-slider-product_noibat_sanpham .swiper-pagination',
			clickable: true,
		},
		navigation: {
			nextEl: '#index-slider-product_noibat_sanpham .swiper-button-next',
			prevEl: '#index-slider-product_noibat_sanpham .swiper-button-prev',
		},
		autoplay: {
			delay: 2500,
			disableOnInteraction: false,
