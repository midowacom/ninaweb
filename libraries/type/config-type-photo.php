...
/* Mạng xã hội 1 */
// $nametype = "tags";
// $config['photo']['man_photo'][$nametype]['title_main_photo'] = "Tags";
...
// $config['photo']['photo_static'][$nametype]['height'] = 285;
// $config['photo']['photo_static'][$nametype]['thumb'] = '120x100x1';
// $config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
/* Favicon */
$nametype = "favicon";
...
// /* Mạng xã hội 1 */
// $nametype = "mangxahoi1";
// $config['photo']['man_photo'][$nametype]['title_main_photo'] = "Icon ngân hàng";
// $config['photo']['man_photo'][$nametype]['number_photo'] = 2;
// $config['photo']['man_photo'][$nametype]['images_photo'] = true;
// $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
// $config['photo']['man_photo'][$nametype]['link_photo'] = true;
// $config['photo']['man_photo'][$nametype]['tieude_photo'] = true;
// $config['photo']['man_photo'][$nametype]['width_photo'] = 85;
...
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 1300;
...
$nametype = "slide_quangcao";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Slide Quảng Cáo";
$config['photo']['man_photo'][$nametype]['number_photo'] = 2;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
$config['photo']['man_photo'][$nametype]['link_photo'] = true;
$config['photo']['man_photo'][$nametype]['tieude_photo'] = true;
$config['photo']['man_photo'][$nametype]['width_photo'] = 630;
$config['photo']['man_photo'][$nametype]['height_photo'] = 250;
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '200x100x1';
$config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';

$nametype = "chi-nhanh";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Chi nhánh";
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = false;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = false;
...
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '200x100x1';
$config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
include __DIR__."/config-sub-module.php";