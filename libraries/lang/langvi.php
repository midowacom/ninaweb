...
define("hotrokythuat","Hỗ trợ kỹ thuật");
define("banggia","Bảng giá");
define("menu_thietke","Thiết kế tự do");
define("menu_bosuutap","Bộ sưu tập");
define("menu_khuyenmai","Khuyến Mãi");
define("menu_sukien","Sự kiện");
define("btn_ft_thietke","Bắt đầu thiết kế");
define("ft_3_label","Thiết kế theo yêu cầu");
define("ft_3_label_2","Liên kết ngân hàng");
define("xuhuong","Xu Hướng");
define("btn_ft_maps","Tọa độ maps");
define("footer_news_label","ĐỂ LẠI THÔNG TIN VÀ NHẬN KHUYẾN MÃI KHI MUA HÀNG");
define("thietkeao","Thiết Kế Áo");
define("account_thong_tin","Thông Tin Thành Viên");
define("thongtin","Thông Tin");
define("account_history_cart","Lịch sử mua hàng");
define("phiship","Phí Ship");
define("tonggia","Tổng giá");
define("madonhang","Mã Đơn Hàng");
define("ngaydat","Ngày Đặt");
define("thongtinchitietsanpham","Thông tin chi tiết sản phẩm");
define("dathangsoluonglon","Giá khi đặt hàng số lượng lớn");
define("quantity","Số lượng");
define("dathangnhanh","Đặt Hàng Nhanh");
define("outstock","Hết hàng");
define("tatca","Tất cả");
define("nhathietke_tacpham","Tác phẩm của nhà thiết kế");
define("sanpham_noibat","Sản phẩm nổi bật");
define("sukien","Sự Kiện ");
define("thietketudo","Thiết kế tư do");
define("bosuutap","Bộ sưu tập");
define("tacphamnhathietke","Tác phẩm nhà thiết kế");
define("khuyenmai","Khuyến Mãi");
define("thongtinnhom","Thông tin nhóm");
define("bandangthuocnhom","Bạn đang thuộc nhóm");
define("muchietkhau","Mức chiết khấu");
define("no_color_choosen","Bạn chưa chọn màu sắc");
define("no_size_choosen","Bạn chưa chọn size nào");
define("_not_enough_items","Hàng trong kho không đủ");
define("_out_stock","Hết hàng");
define("delete_product_from_cart","Bạn có chắc chắn muốn xóa sản phẩm này không?");
define("add_card_success","Thêm vào giỏ hàng thành công");
define("truoc","Trước");
define("sau","Sau");
define("goiychoban","Gợi ý cho bạn");
define("nuocphuvai","Nước phủ vải");
?>